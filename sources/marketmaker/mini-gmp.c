...
char *
mpz_get_str (char *sp, int32_t base, const mpz_t u)
{
  uint32_t bits;
  const char *digits;
  mp_size_t un;
...
int mpz_set_str (mpz_t r, const char *sp, uint32_t base)
{
    uint32_t bits;
    mp_size_t rn, alloc;
    mp_ptr rp;
...
int32_t mpz_init_set_str(mpz_t r, const char *sp, int32_t base) {
    mpz_init (r);
